...
public class CheckoutTest : IClassFixture<TestApplication>
{
    ...
    public async Task SucessfullyPay()
    {
        ...
        {
            new KeyValuePair<string, string>("email", "demouser@computerparts.com"),
        ...
        Assert.Contains("/Basket/CheckoutShipping", checkOutResponse.RequestMessage!.RequestUri!.ToString());
        Assert.Contains("All rights reserved", stringCheckOutResponse);
    }
}
